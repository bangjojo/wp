    ...
    ?> 
     <div class="wrap" id="optionsframework-wrap">
        ...
        <div class="profitmag-header">
            ...
            <div class="profitmag-title">
                <p><?php _e('Donate to Support Us','profitmag'); ?></p>
                <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                <input type="hidden" name="cmd" value="_donations">
                <input type="hidden" name="business" value="dndatnepal@gmail.com">
                <input type="hidden" name="lc" value="US">
                <input type="hidden" name="item_name" value="Wp Gaint">
                    ...
                    <form id="form-options" method="post" action="options.php">
            			...
            			<h3><?php _e( 'Basic Settings', 'profitmag' ); ?></h3>
                           ...
                           <div class="form-row">
                            ...
                            <div class="form-row inline-label">
                					<label class="block"><?php _e('Menu Alignment','profitmag'); ?></label>
            			...
            			<div id="options-group-2" class="group" style="display: none;">
            			     <h3><?php _e('Home Page Settings','profitmag'); ?></h3> 
                                 ...
                                 <div class="form-row inline-label">
                					<label class="block"><?php _e('Featured Block Category (Section Beside Slider )','profitmag'); ?></label>
                                 ...
                                 <div class="form-row inline-label">
                					<label class="block"><?php _e('Featured Block One Category ( Section Below Slider )','profitmag'); ?></label>
                					...
                					<br />
                                    <br />
                                    <label class="block"><?php _e('No of post to display','profitmag'); ?></label>
                                    <input class="mini" type="text" name="profitmag_options[no_of_block_one]" value="<?php echo absint( $settings['no_of_block_one'] ); ?>" />
                   					
            					</div>
                                
                                
                                <div class="form-row inline-label">
                					<label class="block"><?php _e('Featured Block Two Category (Section Below Featured block One )','profitmag'); ?></label>
                                    ...
                                    <br />
                                    <label class="block"><?php _e('No of post to display','profitmag'); ?></label>
                                    <input class="mini" type="text" name="profitmag_options[no_of_block_two]" value="<?php echo absint( $settings['no_of_block_two'] ); ?>" />
                   					
            					</div>
                                
                                  
                                <div class="form-row inline-label">
                					<label class="block"><?php _e('Featured Block Three Category ( 5 Column Block )','profitmag'); ?></label>
                                    ...
                                    <label class="block"><?php _e('No of post to display','profitmag'); ?></label>
                                    <input class="mini" type="text" name="profitmag_options[no_of_block_three]" value="<?php echo absint( $settings['no_of_block_three'] ); ?>" />
                                ...
                                <div class="form-row inline-label">
                                    ...
                                    <br />
                                    <label class="block"><?php _e('No of post to display','profitmag'); ?></label>
                                    <input class="mini" type="text" name="profitmag_options[no_of_block_four]" value="<?php echo absint( $settings['no_of_block_four'] ); ?>" />
                                ...
                                <div class="form-row inline-label">
                					<div class="block-section-title"><?php _e('Featured Block Five','profitmag'); ?></div>
                                    
                                    <div class="block-section-left">
                                        <label class="block"><?php _e('Featured Block Left Category','profitmag'); ?></label>
                                        ...
                                        <br />
                                        <label class="block"><?php _e('No of post to display','profitmag'); ?></label>
                                        <input class="mini" type="text" name="profitmag_options[no_of_block_left]" value="<?php echo absint( $settings['no_of_block_left'] ); ?>" />
                                    </div>
                                    
                                    <div class="block-section-right">
                                        <label class="block"><?php _e('Featured Block Right Category','profitmag'); ?></label>
                                        ...
                                        <br />
                                        <label class="block"><?php _e('No of post to display','profitmag'); ?></label>
                                        <input class="mini" type="text" name="profitmag_options[no_of_block_right]" value="<?php echo absint( $settings['no_of_block_right'] ); ?>" />
                                    </div>
                   					
            					</div>
                                
                                <div class="form-row clearfix">
						          <label class="block"><?php _e('Media Gallery','profitmag'); ?></label>                                                                                                                                        
            			...
            			<div id="options-group-3" class="group" style="display: none;">
            				<h3><?php _e( 'Slider Settings', 'profitmag' ); ?></h3>
                                ...
                                <div class="form-row">
                					<label class="block"><?php _e('Show Slide From','profitmag'); ?></label>                					                                    
				                    <label class="checkbox block" id="single_post_slider"><input value="single_post_slider" type="radio" name="profitmag_options[slider_options]" <?php checked($settings['slider_options'],'single_post_slider'); ?> /><?php _e('Single Posts','profitmag'); ?></label>                                                                      
                                    <label class="checkbox block" id="cat_post_slider"><input value="cat_post_slider" name="profitmag_options[slider_options]" type="radio" <?php checked($settings['slider_options'],'cat_post_slider'); ?> /><?php _e('Category Posts','profitmag'); ?></label>                                                                        									            
            					</div>
                                
                                
                                <div class="form-row post-as-slider" >
                					<label class="block"><?php _e('Select the post that you want to display as a Slider','profitmag'); ?></label>
            			...
            			<div id="options-group-4" class="group" style="display: none;">
                            ...
                            <div class="option-left-sidebar">
                                ...
                                <h4 class="f15"><strong><?php _e( 'Left Sidebar Settings', 'profitmag' ); ?></strong></h4>
                                <div class="form-row inline-label">
                    					<label class="block"><?php _e('Category Sidebar One','profitmag'); ?></label>
                                        ...
                                        <br />
                                        <label class="block"><?php _e('No.of Post to Display','profitmag'); ?></label>
                                        <input class="mini" type="text" name="profitmag_options[left_no_of_cat_post_one]" value="<?php echo absint( $settings['left_no_of_cat_post_one'] ); ?>" />
                                        
               					</div>	
                                
                                <div class="form-row inline-label">
                    					<label class="block"><?php _e('Middle Ads','profitmag'); ?></label>
                    					<textarea cols="60" rows="3" name="profitmag_options[left_sidebar_middle_ads]"><?php echo ( $settings['left_sidebar_middle_ads'] ); ?></textarea>
                                        <br/>
                                        <em class="f13"><?php _e( 'Please insert the image of size 302X222px', 'profitmag'); ?></em>		
              					</div>
                                
                                <div class="form-row">
						          <label class="block"><?php _e('Photo Gallery','profitmag'); ?></label>                                                                                                                                        
                                ...
                                <div class="form-row inline-label">
                    					<label class="block"><?php _e('Category Sidebar Two','profitmag'); ?></label>
                                        ...
                                        <br />
                                        <label class="block"><?php _e('No of post to display','profitmag'); ?></label>
                                        <input class="mini" type="text" name="profitmag_options[left_no_of_cat_post_two]" value="<?php echo absint( $settings['left_no_of_cat_post_two'] ); ?>" />
                                        
               					</div>
                                
                                <div class="form-row inline-label">
                    					<label class="block"><?php _e('Bottom Ads One','profitmag'); ?></label>
                    					<textarea cols="60" rows="3" name="profitmag_options[left_sidebar_bottom_ads_one]"><?php echo ( $settings['left_sidebar_bottom_ads_one'] ); ?></textarea>
                                        <br/>
                                        <em class="f13"><?php _e( 'Please insert the image of size 302X592px', 'profitmag'); ?></em>		
              					</div>
                                
                                <div class="form-row inline-label">
                    					<label class="block"><?php _e('Bottom Ads Two','profitmag'); ?></label>
                    					<textarea cols="60" rows="3" name="profitmag_options[left_sidebar_bottom_ads_two]"><?php echo ( $settings['left_sidebar_bottom_ads_two'] ); ?></textarea>
                                        <br/>
                                        <em class="f13"><?php _e( 'Please insert the image of size 302X592px', 'profitmag'); ?></em>		
              					</div>
                            ...
                            <div class="option-right-sidebar">
                                ...
                                <h4 class="f15"><strong><?php _e( 'Right Sidebar Settings', 'profitmag' ); ?></strong></h4>
                                <div class="form-row inline-label">
                                        <label class="block"><?php _e('Category Posts One','profitmag'); ?></label>
                                        ...
                                        <br />
                                        <label class="block"><?php _e('No of post to display','profitmag'); ?></label>
                                        <input class="mini" type="text" name="profitmag_options[right_no_of_cat_post_one]" value="<?php echo absint( $settings['right_no_of_cat_post_one'] ); ?>" />
                                        
               					</div>	
                                
                                <div class="form-row inline-label">
                    					<label class="block"><?php _e('Middle Ads','profitmag'); ?></label>
                    					<textarea cols="60" rows="3" name="profitmag_options[right_sidebar_middle_ads]"><?php echo ( $settings['right_sidebar_middle_ads'] ); ?></textarea>
                                        <br/>
                                        <em class="f13"><?php _e( 'Please insert the image of size 302X222px ', 'profitmag'); ?></em>		
              					</div>
                                  ...
                                  <div class="right-image-fields clearfix">
                                    ...
                                    ?>
                                                <div class="gal-img-block">
                                                    ...
                                                    <div class="gal-img"><img src="<?php echo $img_url[0]; ?>" /><span class="fig-remove"><?php _e('Remove', 'profitmag'); ?></span></div>
                                ...
                                <div class="form-row inline-label">
                    					<label class="block"><?php _e('Category Posts Two','profitmag'); ?></label>
                                        ...
                                        <label class="block"><?php _e('No of post to display','profitmag'); ?></label>
                                        <input class="mini" type="text" name="profitmag_options[right_no_of_cat_post_two]" value="<?php echo absint( $settings['right_no_of_cat_post_two'] ); ?>" />
                                        
               					</div>
                                
                                <div class="form-row inline-label">
                    					<label class="block"><?php _e('Bottom Ads One','profitmag'); ?></label>
                    					<textarea cols="60" rows="3" name="profitmag_options[right_sidebar_bottom_ads_one]"><?php echo ( $settings['right_sidebar_bottom_ads_one'] ); ?></textarea>
                                        <br/>
                                        <em class="f13"><?php _e( 'Please insert the image of size 302X592px', 'profitmag'); ?></em>		
              					</div>
                                ...
                                <div class="form-row inline-label">
                    					<label class="block"><?php _e('Bottom Ads Two','profitmag'); ?></label>
                    					<textarea cols="60" rows="3" name="profitmag_options[right_sidebar_bottom_ads_two]"><?php echo ( $settings['right_sidebar_bottom_ads_two'] ); ?></textarea>
                                        <br />
                                        <em class="f13"><?php _e( 'Please insert the image of size 302X592px', 'profitmag'); ?></em>		
              					</div>
          					</div><!-- .option-left-sidebar -->
                        ...
                        <div id="options-group-5" class="group" style="display: none;">
                            ...
                            <div class="form-row inline-label">
                					...
                					<textarea cols="60" rows="3" name="profitmag_options[header_ads]"><?php echo ( $settings['header_ads'] ); ?></textarea><br />
            			...
            			<div id="options-group-8" class="group" style="display: none;">
                			<h3><?php _e('Know more about ProfitMag Themes','profitmag'); ?></h3>
                				<div class="form-row">
                		      		<p><?php echo sprintf(__('ProfitMag Theme developed by <a href="%s" target="_blank">WPGaint</a>', 'profitmag' ),esc_url('http://www.wpgaint.com/')); ?></p>
                				</div>		
                                <div class="form-row">
                                    <p><?php _e('For Live Preview of the Theme','profitmag'); ?></p>
                                    <p><a target="_blank" class="button" href="<?php echo esc_url('http://wpgaint.com/wpgiantthemes/profitmag/'); ?>"><?php _e('Live Demo','profitmag'); ?></a></p>
                                </div>	
                                <div class="form-row">
                                    <p><?php _e('For Support / Premium Customization','profitmag'); ?></p>
                                    <p><a target="_blank" href="mailto:ricoshwan@gmail.com">ricoshwan@gmail.com</a></p>
                                </div>
