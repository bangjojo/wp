...
<div id="primary" class="content-area">
                ...
                ?>
                       <!--<h2 class="block-title"><span class="bordertitle-red"></span><?php echo $cat_name; ?>--></h2>
                        <div class="feature-post-wrap clearfix">
                         <img src="/wordpress/wp-content/plugins/geodirectory/geodirectory-assets/images/vdo.png">
                         <br>
                         <br>
                <?php
                    $count = 0;
    ...
    <?php if( !empty( $profitmag_settings['featured_block_two'] ) && $profitmag_settings['featured_block_two']>0 ) : ?>
        ...
        <br>
            ...
            <br>
                ...
                <?php
                if($count % 5 == 0) echo "<div class='clear'></div>";
                        endwhile;
                    endif;
                    wp_reset_postdata();
                ?>
    ...
    <img src="/wordpress/wp-content/plugins/geodirectory/geodirectory-assets/images/Untitled-1.jpg"width="100%">
    <br>
    <br>
