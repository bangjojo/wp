								...
								<form method="post" action=""  id="page_settings">
									...
									<table>
										...
										<tr class="item">
											<td class="label">
												...
												<a href="#" class="info"><img src="<?php echo THEME_IMAGE_URL; ?>control-panel-images/ico-info-1.png" alt="" width="10" height="11" /></a>
													<?php echo orange_themes_info_message("Suggested image size is 333x103px");?>

											</td>
											<td class="setting">
												<?php
													$theme_logo = get_option("bordeaux_logo");
												?>
												...
												<script type="text/javascript">
													jQuery(document).ready(function($){ bordeaux.loadUploader(jQuery("div#logo_upload_button"), "<?php echo THEME_FUNCTIONS_URL;?>upload-handler.php", "<?php echo THEME_UPLOADS_URL;?>");});
												</script>
										...
										<tr class="item">
											...
											<td class="setting">
												<?php
													$currency = get_option("boderaux_currency_category");
												?>
												<span class="input-text-1"><input type="text" name="currency_category" value="<?php echo $currency;?>" style="width: 261px;" /></span>
											</td>
										</tr>
										<tr class="item">
										...
										?>
											<td class="label">Blog list style</td>
											<td class="setting">
												<select name="news_style" class="styled">
													<option value="style_1" <?php if($news_style=="style_1" || !$news_style) echo "selected=\"selected\"";?>>Style 1 (News and posts with small images)</option>
													<option value="style_2" <?php if($news_style=="style_2") echo "selected=\"selected\"";?>>Style 2 (News and posts with big images)</option>
												</select>
											</td>
										</tr>
										<tr class="item last">
