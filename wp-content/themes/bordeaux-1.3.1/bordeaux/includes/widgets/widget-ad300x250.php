...
class tz_ad300_widget extends WP_Widget {
	...
	function TZ_Ad300_Widget() {
		...
		/* Create the widget */
		$this->WP_Widget( 'tz_ad300_widget', __('Bordeaux Custom 250x250 Ad', 'framework'), $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		//echo 	'<div class="sidebar-block-1">';
	...
	function form( $instance ) {
		...
		$defaults = array(
		'title' => '',
		'ad' => get_template_directory_uri()."/images/banner-250x250.jpg",
